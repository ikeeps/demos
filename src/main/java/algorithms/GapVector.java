 ...
 * contents directly to accomodate the change.
 *
...
abstract class GapVector implements Serializable {
     ...
     * This will move the gap to the area being changed if the gap is not currently
     * located at the change location.
     *
     * @param position
     *            the location to make the replacement. This is not the location in
     *            the underlying storage array, but the location in the contiguous
     *            space being modeled.
     * @param rmSize
    ...
    /**
     * Adjust the gap end downward. This doesn't move any data, but it does update
     * any marks affected by the boundary change. All marks from the old gap start
     * down to the new gap start are squeezed to the end of the gap (their location
     * has been removed).
     */
     ...
     * marks affected by the boundary change. All marks from the old gap end up to
     * the new gap end are squeezed to the end of the gap (their location has been
     * removed).
     */
